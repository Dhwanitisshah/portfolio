...
export default function ProjectCard({ project }: { project: Project }) {
  return (
    <article className="rounded-lg border border-border bg-surface px-8 py-7 transition-[border-color,box-shadow] duration-200 hover:border-sage hover:shadow-lift">
